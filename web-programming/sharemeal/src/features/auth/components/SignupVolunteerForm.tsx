...
export function SignupVolunteerForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Signup Volunteer:', formData);
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-lg p-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm">Register as volunteer</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Time Slots */}
        <div>
          <label htmlFor="timeSlots" className="block text-sm font-medium text-gray-700 mb-1.5">
            Time Slots
          </label>
          <input
            type="text"
            ...
            onChange={handleChange}
            placeholder="Select availability time slots"
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all"
            required
          />
        </div>
